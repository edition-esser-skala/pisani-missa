...
KyrieClarinoI = {
  \transpose d c \relative c' {
    ...
    d4 r8 fis d4 r %35
    r \pa fis8 fis fis fis16 fis fis8 fis
    g e \pd r4 r \pa fis8 fis \pd
    g g16 g g8 g \pao e4 r
    \pao fis8 r r4 \pa r8 e a h
    ...
    fis e16 d e8 e d fis g a %85
    d, d16 e fis8 e16 d e8 a, g' fis16 e \pd
    fis a g a fis a g a fis2~
    fis8 a fis a fis a fis a
    fis4 r r8 \pa fis g a
    d,2 \pd r\fermata \bar "|." %90 finis
  }
}
