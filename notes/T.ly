...
CredoTenoreNotes = {
	\relative c' {
		...
		r4 \mvTr d\fE^\tuttiE c4. f8
		d([ es)] f([ d)] es2
		d4 r r8 c f f
		f8([ es?16 d)] es8 f d4. g,8
		c4. f8 d4 b %5
		c r r2
		R1
		r2 r4 es8 es
		...
		d4 c8([ f)] d4 c8([ d)] %30
		b2 a4 f'8 f
		es?([ cis)] d e16([ f)] d4 cis
		d \mvTr f\fE^\tuttiE f e8 e
		f8. c16 c8 f f es16([ d)] es4~
		es d8 d c2 %35
		d4 r8 d b b r es
		es8[( c)] d d c4( d
		c2) b4 r
		R1*2 \noBreak %40
		R1\fermataMarkup \bar "||"
		\tempoEtIncarnatus r4 \mvTr es2\fE^\tuttiE es8 es \noBreak
		d4 es d r8 d
		es4 es8 es es4( c)
		d d4. d8 d d %45
		c4.( es8 f4.) f8
...
CredoTenoreLyrics = \lyricmode {
	...
	Pa -- tri, per quem
	o -- mni -- a fa -- cta
	sunt. \xE Qui pro -- pter nos
	ho -- mi -- nes et pro -- pter no --
	stram sa -- lu -- %35
	tem de -- scen -- dit, de --
	scen -- dit de coe --
	lis.
...
BenedictusTenoreNotes = {
	\relative c' {
		...
		\key b \major \time 3/2 \tempoOsanna
			...
			d1 d2 \noBreak
		\time 6/2 c2. c4 b2 c d( g) %70
		c,1 r2 r r d
		\time 3/2 d d d
		\time 6/2 c2. c4 b2 b b( a)
		b2 \tempoOsannaFinis b b b1 es2~
		es2 d c d1.\fermata \bar "|." %75 finis
	}
}
