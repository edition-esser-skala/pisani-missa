...
CredoBassFigures = \figuremode {
	...
	<6!> <[_-]> <6> <_!> <[_-]>4 <[6]>
	<4> <6>8 <[_!]> <[9] _-> <\t \t> <6>4 %55
	<6- [4]> <5 [_-]> <[6-] 4 2->8 <\t \t \t> <[6] _->8 <[5] \t>
	<6 4! 2>4 <6> <6!> <_->
	<4> <_!> <_->2
	<[5-]>4. <[6- 4 3]>8 <[6 4! _-]>4. \bassFigureExtendersOn <6 4! _->8 \bassFigureExtendersOff
	...
	r <7> <6!>
	r2 <6>4
	<[6 5]>2. \bassFigureExtendersOn %145
