...
LaudamusSopranoINotes = {
  \relative c' {
    ...
    r4 r8 \mvTr h'\pE^\solo e16[ fis] \appoggiatura fis8 g4 fis8 %115
...
QuoniamSopranoINotes = {
  \relative c' {
    ...
    R1*9 %504
    \mvTr d'8.\pE^\solo g,16 g([ a)] b([ c)] d8 g, r g' %505
