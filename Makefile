...
project = Pisani_Missa_in_D
notes = fl ob1 ob2 cor1 cor2 tr1 tr2 timp vl1 vl2 vla S1 S2 A T B org
scores = full_score fl1 fl2 ob1 ob2 cor12 tr12timp vl1 vl2 vla coro org b
